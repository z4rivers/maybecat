  ...
  return (
    ...
    >
        ...
        <div className="flex-1 flex flex-col">
          {!catImage ? (
            ...
            >
              ...
              <p 
                className="text-xl md:text-2xl font-bold text-center px-4 py-1"
                style={{ 
                  fontFamily: "'Cinzel Decorative', Georgia, serif",
                  color: '#FEF3C7',
              ...
              >
                ✦ CHOOSE YOUR ORACLE AND ASK YOUR QUESTION ✦
              </p>
                ...
                {loadingShelterCats ? (
                  ...
                  shelterCats.map((cat, i) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className="w-44 h-68 md:w-52 md:h-[320px] lg:w-56 lg:h-[360px] rounded-lg overflow-hidden relative"
                          style={{
                            background: color.bg,
      ...
      {!isMaybeCatDomain && (
        <Link
          to="/"
          className="block w-full h-96 md:h-[32rem] lg:h-[40rem] transition-all hover:brightness-110"
          style={{
