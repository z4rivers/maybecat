...
export const oracleResponses: OracleResponse[] = [
  ...
  { text: "You hit send. The universe hit receive.", category: 'existential' },
  ...
  { text: "Wearing a crown is a mindset, not an accessory.", category: 'demanding' },
  ...
  { text: "Nobody is good at talking, so just say something.", category: 'wise' },
  { text: "I don't know. I'm not a scientist.", category: 'chaotic' },
  { text: "If it's not working out, it's not the end.", category: 'heartfelt' },
  { text: "Everything must be leopard print.", category: 'demanding' },
  { text: "Show up on time, and have a good time.", category: 'wise' },
  { text: "Get a grip, get a life, and get over it.", category: 'cold' },
  ...
  { text: "The answer lives in your stomach, not your head.", category: 'wise' },
  ...
  { text: "Forgive them. Free up space.", category: 'wise' },
  ...
  { text: "Tell me what you want. Not what sounds safe.", category: 'demanding' },
  { text: "You have feet. Use them or don't.", category: 'demanding' },
  { text: "Between hither and yon, you'll get screwed.", category: 'wise' },
  { text: "The route is not marked.", category: 'demanding' },
  { text: "Laughter matters. No laughter? Wrong relationship.", category: 'wise' },
  { text: "Say it. Not the polite version.", category: 'demanding' },
  ...
  { text: "Some kind of humor required.", category: 'demanding' },
  ...
  { text: "By the side of every why, there's a yes.", category: 'wise' },
  { text: "Beware of muddle.", category: 'wise' },
  ...
  { text: "Only connect.", category: 'heartfelt' },

  // === SASHA BARON COHEN ENERGY (Feb 14 2026) ===
  { text: "Very nice. Next question.", category: 'cold' },
  { text: "Kindness doesn't need context.", category: 'heartfelt' },
  ...
  { text: "Maybe the question is wrong.", category: 'wise' },
  ...
  { text: "Being like everybody is the same as being nobody.", category: 'wise' },
  { text: "Knowing doesn't save you. But not knowing is worse.", category: 'wise' },
  ...
  // === SYNTH/PEDAL ENERGY (Feb 14 2026) ===
  { text: "Bring openness, clarity, and crunch.", category: 'demanding' },
  ...
  { text: "Combine various moments from the past and harmonize with yourself.", category: 'wise' },
  ...
  { text: "Value imperfection, chance, and emotional resonance.", category: 'wise' },
  { text: "That operates outside the range of beepy-boopy or buzzy computer noises.", category: 'cold' },
  { text: "Set aside expectations and explore what beauty is.", category: 'heartfelt' },
  { text: "It is day 87 and the doubts have accepted me as one of their own.", category: 'heartfelt' },
  { text: "Technical limitations and obscure instruments can be a source of creative inspiration.", category: 'wise' },
  ...
  { text: "Great plan! Hope it works.", category: 'judgy' },
  { text: "You are going in circles, race car!", category: 'chaotic' },
  { text: "It's already over. Check what it cost you.", category: 'cold' },
  { text: "That empty feeling gives you room for discovery.", category: 'wise' },
  { text: "You think you have options, but not all are viable.", category: 'cold' },
  { text: "The shiny option will get your attention. Doesn't matter how much better the safe choice is.", category: 'wise' },
  ...
  { text: "Ghosts, shadows and whispers can be the toughest opponents to defeat.", category: 'wise' },
  ...
  { text: "Cats and laughs - all that really matter.", category: 'nurturing' },
  ...
  { text: "There are stages. You cannot skip to the peak.", category: 'wise' },
  { text: "Achieve joy fourteen times a day.", category: 'demanding' },
  { text: "Forty-five minutes of peace comes from a good laugh.", category: 'nurturing' },
  ...
  { text: "Believe in your ability - to cheer up a cat.", category: 'nurturing' },
  ...
  { text: "You know what your problem is? You're a golden retriever in a cat's world. You need everyone to like you. I need NO ONE. And everyone loves me.", category: 'judgy' },
  ...
  { text: "You care. Most people don't even get that far.", category: 'nurturing' },
  ...
  { text: "WAIT — you have someone who LOVES you and you're not sure?! I'm in a CAGE, dude! I would KILL for someone to be unsure about me!", category: 'adoption' },
