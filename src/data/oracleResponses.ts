...
export const oracleResponses: OracleResponse[] = [
  ...
  { text: "Tuna hits different when you're not supposed to have it.", category: "cryptic" },
  { text: "*kneads aggressively* It's not done until I say it's done.", category: "demanding" },
  { text: "The countertop is cold at first. You get used to it.", category: "physical" },
  { text: "*presents belly* This is not an invitation. Unless it is. Read the room.", category: "physical" },
  ...
  { text: "Dilated pupils and increased vocalization. Neither party will yield.", category: "cryptic" },
  ...
  { text: "You are not a glacier, so go ahead and care.", category: "wholesome" },
  { text: "Somewhere a star is dying. Remembered to water the plants.", category: "poetic" },
  { text: "Everything terrible is someone else's department.", category: "sassy" },
  ...
  { text: "Instructions unclear. Started a new life.", category: "chaotic_wholesome" },
  { text: "Fortune favors you specifically right now and I cannot explain why.", category: "cryptic" },
  { text: "What's the worst that happens? You become interesting.", category: "chaotic_wholesome" },
  { text: "The universe doesn't care if you're ready. It barely cares if you're dressed.", category: "existential" },
  { text: "You are overqualified for the couch but underqualified for the bed. There's a waitlist for the chair.", category: "sassy" },
  { text: "Somewhere in this house there's a second government that is responsible for all consequential decisions.", category: "cryptic" },
  ...
  { text: "There are green-gray fuzzy islands forming and you're calling it personal growth.", category: "sassy" },
  { text: "Firefly out there just giving it away for free. No strategy. All glow.", category: "chaotic_wholesome" },
  { text: "I brought the cricket inside. Now it's an inside cricket.", category: "chaotic_wholesome" },
  ...
  { text: "Of course the cat is upset to be wearing a sweater. It has no matching accessories, and this is more of a hoodie style cat.", category: "sassy" },
