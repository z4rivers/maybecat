...
export const oracleResponses: OracleResponse[] = [
  ...
  { text: "Six versions of your future say maybe. One is laughing hysterically.", category: 'mystical' },
  ...
  { text: "*stares* I don't know what you did. I don't care.", category: 'nurturing' },
  ...
  { text: "Patience has limits. You've found them.", category: 'angry' },
  ...
  { text: "Human courtship is... unnecessarily elaborate.", category: 'judgy' },
  ...
  { text: "*tracks something invisible across the ceiling* ...Yes.", category: 'chaotic' },
  ...
  { text: "*knocks over your water glass* The spirits have spoken.", category: 'chaotic' },
  ...
  { text: "When the water's too still, splash around.", category: 'chaotic' },
  ...
  { text: "Brave and stupid - very similar recipes.", category: 'chaotic' },
  ...
  { text: "... like your heart will follow a spreadsheet.", category: 'wise' },
  ...
  { text: "Go home and tell your cat everything in a voice that would get you fired.", category: 'wise' },
  ...
  { text: "You can sit with us. We like all kinds of confused.", category: 'cold' },
  ...
  { text: "Solving this will require a full time cat.", category: 'cold' },
  ...
  { text: "I've been looking at this toy for twenty minutes. It hasn't moved.", category: 'chaotic' },
  ...
  { text: "Reply to all and watch the world burn.", category: 'chaotic' },
  ...
  { text: "*settles on your laptop* This is mine now.", category: 'demanding' },
  ...
  { text: "The Amazon box is my home. The bed is decorative.", category: 'judgy' },
  ...
  { text: "The shiny things are alive. I'm sure of it.", category: 'chaotic' },
  { text: "*ornament crashes* That one was structurally unsound.", category: 'chaotic' },
  ...
  { text: "I wasn't listening. Say it again but more interesting.", category: 'judgy' },
  ...
  { text: "Have you tried bribing me?", category: 'demanding' },
  ...
  { text: "I'll walk on your face at 4am. Dream while you can.", category: 'poetic' },
  ...
  { text: "I brought you my favorite toy. It's a bottle cap.", category: 'nurturing' },
  ...
  { text: "We get to be bad on bad days, right?", category: 'nurturing' },
  ...
  { text: "*matches your breathing just like the cats in scary movies* Still trust me?", category: 'poetic' },
  ...
  { text: "Wait until the bowl is full. Then you'll know.", category: 'wise' },
  ...
  { text: "The signs were there. You ignored them.", category: 'judgy' },
  ...
  { text: "You miss 100% of the naps you don't take.", category: 'chaotic' },
  ...
  { text: "Pivot like this was the plan all along.", category: 'chaotic' },
  ...
  { text: "Anxiety is just your brain being REALLY helpful about things that MIGHT happen! Thanks, brain!", category: 'chaotic' },
  ...
  { text: "Is it the question or the answer that scares you?", category: 'mystical' },
  ...
  { text: "You've confused being loud with being right.", category: 'cold' },
  ...
  { text: "You're browsing the sad produce.", category: 'existential' },
  ...
  { text: "The thing you love has been ruined. Mourn and move on.", category: 'cold' },
  ...
  { text: "Common sense isn't common. You're proving it.", category: 'judgy' },
  ...
  { text: "I care about you. From a distance. But genuinely.", category: 'heartfelt' },
  ...
  { text: "That seems like a lot of effort for a little result.", category: 'judgy' },
  { text: "I've seen this before. It doesn't end well.", category: 'cold' },
  ...
  { text: "\"Eat or be eaten\" ... could be terrible or amazing.", category: 'cold' },
  ...
  { text: "Something broke and you're at ground level holding it together with both hands. *cat swishes tail in your face*", category: 'heartfelt' },
  ...
  { text: "You might always be $3 short.", category: 'cold' },
  ...
  { text: "Start each morning expecting the worst. Either it improves or you called it.", category: 'wise' },
  ...
  { text: "Sometimes you hear what you need from someone who wasn't talking to you.", category: 'poetic' },
  ...
  { text: "You flinched at your own decision.", category: 'poetic' },
  ...
  { text: "Surrender when a yawn takes over your whole face.", category: 'poetic' },
  ...
  { text: "After being buried for so long, that feeling is translucent.", category: 'poetic' },
  ...
  { text: "Why are you whispering?", category: 'demanding' },
  ...
  { text: "You're sleeping in the wet spot because you're too tired to move.", category: 'demanding' },
  ...
  { text: "27% of randomly generated sentences are \"profound.\"", category: 'wise' },
  ...
  { text: "Settle for menu options. Settle for drapes in your second-choice color. Not for this.", category: 'demanding' },
  ...
  { text: "Have you been dreaming of giant cat towers and unlimited tuna buffets?", category: 'chaotic' },
  ...
  { text: "If you'd rather sit in the box alone, there's your answer.", category: 'wise' },
  { text: "If I have to meow more than twice to get what I need, the arrangement isn't working.", category: 'demanding' },
  ...
  { text: "I have OPTIONS. But options don't keep you warm at 3 AM.", category: 'wise' },
  ...
  { text: "The thing about your little problem is... it ain't little to you.", category: 'mystical' },
  ...
  { text: "I heard the heartbeat the moment that question walked in.", category: 'mystical' },
  ...
  { text: "They KNOW you're on hold. That music is a patience test.", category: 'wise' },
  ...
  { text: "A bread tie from under the fridge! - just like forgotten cash in an old jeans pocket.", category: 'wise' },
  ...
  { text: "Yes, like wearing the perfect gear in lousy weather.", category: 'wise' },
  { text: "Yes, like a mouse not seeing you and running right in your direction.", category: 'wise' },
  { text: "Yes, like a flying acrobatic leap to catch a cat feather toy high in the air.", category: 'chaotic' },
  ...
  { text: "You're the weird treasure at the yard sale.", category: 'nurturing' },
  ...
  { text: 'Make up a cat-inspired war chant. Perform it standing on their desk in front of them.', category: 'chaotic' },
  ...
  { text: "Once you do it, we will know. We'll be waiting with popcorn.", category: "nurturing" },
  ...
  { text: "Ooh yeah, that's just the right amount. And juicy too. Dang - that's good.", category: "chaotic" },
  ...
  { text: "\"Navigating a new relationship is hard... rules about where you're allowed to poop, about who you can bite or scratch \u2014 or sleep on.\"", category: "wise" },
  ...
  { text: "Your argument is morally unimpeachable and rhetorically flawless... but the cat agrees with me.", category: "chaotic" },
  ...
  { text: "I match your stress tension with kitty sniffs and a kind meow of concern.", category: "nurturing" },
