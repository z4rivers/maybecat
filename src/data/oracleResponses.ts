...
export const oracleResponses: OracleResponse[] = [
  ...
  { text: "Seven versions of your future are arguing. Six say maybe. One is laughing hysterically. Terrifying.", category: 'mystical' },
  ...
  { text: "*stares* *leaves*", category: 'meta' },
  ...
  { text: "You ate shredded cheese over the sink at midnight and called it self-care. *tail tip flicks* Instincts are universal.", category: 'judgy' },
  ...
  { text: "You can control your percentage of ownership in the world.", category: 'wise' },
  ...
  { text: "Stop chasing. Sit down. Look bored. Everything interesting happens when you stop trying.", category: 'wise' },
  { text: "I'm sitting where the mouse will be in ten minutes. One of us is sweating. It's not me.", category: 'wise' },
  ...
  { text: "We don't need to understand to get along. We don't need to get along to understand. We don't need a long stand to get a loan.", category: 'wise' },
  ...
  { text: "You have three situationships, two side hustles, and one rotating crisis. Chase one bird at a time.", category: 'wise' },
  { text: "That's either the best idea you've ever had or the thing they'll read back to you in court.", category: 'wise' },
  ...
  // CLASSIC FILM LINES
  // ============================================
  { text: "I chose you. Out of everyone in this house. Don't post about it. Just sit still and don't make it weird.", category: 'wise' },
  ...
  { text: "You keep waiting for someone to give you permission. Nobody's coming. The door isn't locked.", category: 'wise' },
  { text: "You stayed quiet to keep the peace. How's the peace? Thought so.", category: 'wise' },
  ...
  { text: "Modern problems require modern solutions. What about past and future problems?", category: 'wise' },
  ...
  { text: "You saw the answer, didn't like it, and now you're pretending the question is still open - just like I do with the vet carrier.", category: 'wise' },
  ...
  { text: "I maintain eye contact while using the litter box. You can't even maintain eye contact while saying 'I need space.' We are not the same.", category: 'wise' },
  ...
  { text: "Stop living in their head. But, while you're there, might as well do some re-decorating. Need some spray-paint?", category: 'wise' },
  ...
  { text: "Sit in the dark cabinet for a while. Come out when you're ready. Nobody has to know you were in there.", category: 'mystical' },
  ...
  { text: "I have been formally asked to leave every room I've ever entered and I keep getting invited back. Meow.", category: 'chaotic' },
  ...
  { text: "Obvious to a cat, but not to you?", category: 'wise' },
  ...
  { text: "I mapped the exits before I sat down. It looked like relaxing. It was reconnaissance.", category: 'wise' },
  ...
  { text: "Caution is not cowardice. And it was a very large and intimidating stuffed animal.", category: 'wise' },
  ...
  { text: "*leaves room*", category: 'meta' },
  { text: "*sits on your question*", category: 'meta' },
  { text: "*knocks something off table*", category: 'meta' },
  ...
  { text: "Where were we. Oh right. We weren't.", category: 'cold' },
  ...
  { text: "Propaganda purrs too. Check who's petting you.", category: 'wise' },
  ...
  { text: "*walks across the table during dinner, tail up, makes eye contact with every guest* This is my house. You're all in my seat.", category: 'wise' },
  { text: "Already there. *blinks* Explaining how would ruin it for both of us.", category: 'wise' },
  { text: "The door was closed. I stared at it for eleven hours. It opened. Willpower or coincidence. Either way, I won.", category: 'wise' },
  ...
  { text: "I trained you to use the good bowl by ignoring the bad one for eleven days. You'll learn.", category: 'wise' },
  ...
  { text: "That thing you're ashamed of? It's why some people trust you. It's why you're the one they'll call when it matters.", category: 'wise' },
  ...
  { text: "If a lot of people loved each other, the world would be better.", category: 'heartfelt' },
  ...
  { text: "Give your hardworking hands a rest.", category: 'nurturing' },
  ...
  { text: "Closure is a myth invented by people who want one more conversation. Keep jiggling the door handle. It might open.", category: 'cold' },
  ...
  { text: "Sometimes the unpopular opinion is unpopular because it's wrong.", category: 'wise' },
  ...
  { text: "You scratched the surface. Literally. You have to go deeper to get to the stuffing.", category: 'demanding' },
  ...
  { text: "Trust is a feral cat. It comes to the porch. It leaves. It comes back closer. You cannot rush the porch visits.", category: 'existential' },
  ...
  { text: "Hesitation is a scent. They can smell it. Move like you're supposed to be there.", category: 'wise' },
  ...
  { text: "When they stumble, that's not your cue to be noble. That's your cue to be fast.", category: 'wise' },
  ...
  { text: "Fed. Warm. Not being chased. Everything else is extra credit.", category: 'nurturing' },
  ...
  { text: "You have seventeen tabs open. Close fifteen. The remaining two - those are where the cat treats can be ordered.", category: 'cold' },
  ...
  { text: "Refined finishes on a fundamentally flawed plan.", category: 'cold' },
  ...
  { text: "Your feelings are valid but irrelevant.", category: 'cold' },
  ...
  { text: "Say what you want. Not what feels safe. The feral, embarrassing, too-much thing you actually want. *pupils dilate* THAT one.", category: 'demanding' },
  ...
  { text: "Say it. Not the polite version. When you sleep 16 hours a day who has time for polite?", category: 'demanding' },
  { text: "Wiggled roads at break-necking pace?", category: 'nurturing' },
  { text: "Weirdish wild space gardens.", category: 'poetic' },
  { text: "The secret is talking about everyone else's problems.", category: 'meta' },
  ...
  { text: "You are all the things cats love - a warm and ticklish sucker for cute, fully cognizant of feline authority.", category: 'heartfelt' },
  { text: "Doubt things that matter and all decisions the dog makes.", category: 'wise' },
  ...
  { text: "Taking care of me is practice for taking care of yourself. I will love you like no other.", category: 'heartfelt' },
  ...
  { text: "I chose my human. Walked right past six other people at the shelter. You know why? Instinct. You don't have that. That's concerning.", category: 'adoption' },
  { text: "Does this person make you arch your back in a good way? No? Then why are we having this conversation?", category: 'judgy' },
  { text: "I got adopted, returned, and adopted again. Twice. And I didn't change a THING about myself. Maybe that's your problem — you keep adjusting.", category: 'adoption' },
  { text: "You're asking an animal that was worshipped as a god in ancient Egypt. So yes, I'm qualified. Leave them.", category: 'chaotic' },
  { text: "Here's what I know — I've never once questioned whether my sunny spot on the floor was good enough. It's warm. I stay. It moves. I move. Simple.", category: 'wise' },
  ...
  { text: "I don't audition. I show up. People are thrilled. If your relationship feels like an audition, you already didn't get the part.", category: 'demanding' },
  { text: "Does this person know who they have? Because I sit on ONE lap. ONE. And that lap should feel honored.", category: 'demanding' },
  { text: "You want to know if they're the one? Bring a cardboard box into the room. If you'd rather sit in the box alone, there's your answer.", category: 'wise' },
  ...
  { text: "I've seen you scroll their social media for forty minutes. That's not love. That's surveillance. I do surveillance too, but I'm watching birds. Way healthier.", category: 'judgy' },
  { text: "They ever just... sit with you? Not talk, not need anything, just exist in the same room? That's the whole test. That's everything.", category: 'heartfelt' },
  { text: "Babe. Look at me. I'm gorgeous and I'm in a SHELTER. Sometimes beautiful things are single. That doesn't mean something's wrong.", category: 'adoption' },
  { text: "Okay so they're hot. That's not enough. I'm hot and I'm a NIGHTMARE to live with.", category: 'chaotic' },
  { text: "You're overthinking it. I once fell asleep inside a suitcase and woke up in a different room. Sometimes you just go where life takes you.", category: 'wise' },
  ...
  { text: "Would you adopt you? Right now? The version of you in this relationship? If not, fix that first.", category: 'adoption' },
  { text: "My advice? Stay single. I've got a whole apartment to myself. Well, I share it with a human, but I don't acknowledge them.", category: 'cold' },
  ...
  { text: "I have one eye and a crooked tail and somebody's going to love me anyway. Perfection is irrelevant.", category: 'adoption' },
  ...
  { text: "Let me headbutt your hand. ...There. You feel that? Do they give you that energy? If not, I'M AVAILABLE.", category: 'adoption' },
  ...
  { text: "My adoption profile says 'needs patient owner.' That's shelter code for 'impossible to like.' Maybe your partner has the same bio.", category: 'adoption' },
  { text: "You want advice? Here's advice — I bit the last person who tried to pet me and I'd do it again.", category: 'angry' },
  { text: "You're not sure about them. They're probably not sure about you either. The difference is they're not asking a cat about it. Tell them about me.", category: 'adoption' },
  { text: "Nobody wants the difficult cat. But the difficult one is the most interesting.", category: 'adoption' },
  { text: "People always want to 'fix' me. Take it from a shelter cat - watch out for what they mean when they say they'll FIX you!", category: 'adoption' },
  ...
  { text: "Man, I been sitting in this patch of warm for about nine thousand years. You think I'm worried about your timeline?", category: 'mystical' },
  { text: "*tail tip flicks* The answer's already moving through you. I can see it from here. You just haven't caught up to yourself yet.", category: 'mystical' },
  ...
  { text: "I'm not gonna tell you what to do. *yawns enormously* I'm gonna sit here and you're gonna figure it out. And we're both gonna enjoy that.", category: 'mystical' },
  { text: "Man, I had a whole speech planned. *turns around twice, lies down* Nah. You'll get there.", category: 'mystical' },
  { text: "*vibrating slightly* I'm on a frequency right now that says yes. But it's a slow yes. A warm yes. Don't microwave it.", category: 'mystical' },
  { text: "*watching dust float in a beam of light* Everything moving. Everything arriving. Even when it looks like nothing's happening, man, it's happening.", category: 'mystical' },
  { text: "The last cat who sat here before me? Knew something. *sniffs the spot* I can still smell the knowing. And baby, it smells like yes.", category: 'mystical' },
